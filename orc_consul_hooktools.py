...
if __name__ == '__main__':
    ...
    parse.add_argument('--set-ha-template', help='set haproxy config to consul-template', action='store_true',
                       default=False)
    parse.add_argument('-v', '--version', help='print version', action='store_true', default=False)
    parse.add_argument('-f', '--filename', help='the haproxy template filename', default=False, metavar='',
                       type=argparse.FileType('a+'))
    parse.add_argument('-t', '--consul-token', help='set consul token if token is needed', metavar='',
                       default=False)
